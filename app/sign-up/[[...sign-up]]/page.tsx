  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-16">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div
          className="absolute -top-40 right-1/4 h-[600px] w-[600px] rounded-full opacity-[0.07]"
          style={{
            background:
        ...
        />
        <div
          className="absolute -bottom-40 left-1/4 h-[500px] w-[500px] rounded-full opacity-[0.05]"
          style={{
            background:
